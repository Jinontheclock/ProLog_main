      ...
      <ScrollView style={CommonStyles.scrollView} showsVerticalScrollIndicator={false} contentContainerStyle={CommonStyles.scrollContent}>
        ...
        <View style={styles.mainInfoCard}>
          ...
          <View style={styles.summarySection}>
            ...
            <Text style={styles.summaryText}>Amount: up to ${FINANCIAL.MAX_LOAN_AMOUNT.toLocaleString()}</Text>
            <Text style={styles.summaryText}>Provider: {FINANCIAL.LOAN_PROVIDER}</Text>
          </View>
          ...
          <View style={styles.bulletPoints}>
            <View style={styles.bulletPoint}>
              ...
              <Text style={styles.bulletText}>
                The Government of Canada offers apprentices registered in a Red Seal Opens a new window Trade apprenticeship program up to ${FINANCIAL.MAX_LOAN_AMOUNT.toLocaleString()} per period of technical training.
              </Text>
            </View>
            <View style={styles.bulletPoint}>
              <Text style={styles.bullet}>•</Text>
              <Text style={styles.bulletText}>
                You can get Canada Apprentice Loans for up to {APPRENTICESHIP.MAX_LOAN_PERIODS} periods of technical training.
              </Text>
            </View>
            <View style={styles.bulletPoint}>
              <Text style={styles.bullet}>•</Text>
              <Text style={styles.bulletText}>
                Your loan will be payment-free for up to {APPRENTICESHIP.LOAN_PAYMENT_FREE_WEEKS} weeks/6 years as long as you are confirmed as being registered in a Red Seal Opens a new window Trade apprenticeship program.
              </Text>
            </View>
            <View style={styles.bulletPoint}>
              <Text style={styles.bullet}>•</Text>
        ...
        <View style={styles.sectionCard}>
          ...
          <Text style={styles.eligibilitySubtitle}>
            To be eligible, you must meet all of these criteria{'\n'}(the eligibility has been determined based on your profile)
          </Text>
