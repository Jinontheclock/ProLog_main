...
const QuizScreen = () => {
  ...
  if (completed) {
    return (
      <View style={styles.container}>
        ...
        <Pressable style={styles.button} onPress={() => router.replace('/(tabs)/QuizScreen', { skillId: skillId as string, skillTitle: skillTitle as string })}>
  ...
  return (
    <View style={styles.container}>
      <QuizHeader title={`Question ${currentQuestionIndex + 1} / ${questions.length}`} />
