...
export default function WorkScreen() {
    ...
    const [expandedExpenseCard, setExpandedExpenseCard] = useState<
        number | null
    >(1);
        ...
        <View style={[styles.container, { backgroundColor: "#F0F0F0" }]}>
            ...
            >
                ...
                <SectionHeading
                    ...
                    percentage={getCurrentData(
                        workPageData.sectionHeading.percentage
                    )}
                    ...
                    <>
                        ...
                        <ContentDataFormats
                            mainItems={[
                                {
                                    label: "Sponsor",
                                    value: workPageData.apprenticeshipDetails
                                        .sponsor,
                                },
                                {
                                    label: "Countdown (Est.)",
                                    value: getCurrentData(
                                        workPageData.apprenticeshipDetails
                                            .estimatedDaysToGo
                                    ),
                                },
                            ]}
                        ...
                        <View style={styles.sectionHeader}>
                            ...
                            <TouchableOpacity
                                onPress={() =>
                                    setShowDiscrepancyInfoModal(true)
                                }
                            >
                                <MaterialIcon
                                    name="info"
                            ...
                            items={[
                                {
                                    ...
                                    hours: getCurrentData(
                                        workPageData.discrepancyTracking
                                            .paystubHours
                                    ),
                                    unit: "hrs",
                        ...
                        <View style={styles.sectionHeader}>
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() =>
                                    router.push("/paystubs/PaystubList")
                                }
                            >
                                <MaterialIcon
                ...
                {selectedTab === "skills" && (
                    <>
                        ...
                        <CompetencyCompletion
                            ...
                            showInfoIcon={true}
                            onInfoPress={() =>
                                setShowCompletionDetailsInfoModal(true)
                            }
                    ...
                    <>
                        ...
                        <View style={styles.financeHeaderContainer}>
                            <View style={styles.financeHeaderRow}>
                                ...
                                <TouchableOpacity
                                    onPress={() =>
                                        setShowPotentialExpensesInfoModal(true)
                                    }
                                >
                                    <MaterialIcon
                                        name="info"
                        ...
                        <ExpenseCard
                            ...
                            onToggle={() =>
                                setExpandedExpenseCard(
                                    expandedExpenseCard === 1 ? null : 1
                                )
                            }
                        />
