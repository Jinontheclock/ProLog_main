        ...
        <View style={styles.searchContainer}>
          <View style={[CommonStyles.neoInsetOuter, { flex: 1, borderRadius: 20 }]}>
            <View style={[styles.searchBox, CommonStyles.neoInsetInner, { borderRadius: 20 }]}>
              <MaterialIcon name="icon-search" size={20} color="#999" />
              <TextInput
          ...
          <View style={[CommonStyles.neoDoubleOuter, { borderRadius: 20 }]}>
            ...
            >
              <MaterialIcon name="icon-filter" size={20} color="#2C2C2C" />
            </TouchableOpacity>
          </View>
        </View>
              ...
              {expandedSections[section.title] && (
                <View style={styles.sectionItems}>
                  {section.items.map((item, itemIdx) => (
                    ...
                    >
                      <MaterialIcon
                        name={completedItems[item] ? 'icon-check' : 'icon-checkbox-empty'}
                        size={20}
                        color={completedItems[item] ? '#2C2C2C' : '#999'}
                      />
                      <Text style={[
                      ...
                      <MaterialIcon name="icon-chevron-right" size={20} color={Colors.text.primary} />
                    </TouchableOpacity>
                  ))}
                </View>
              )}
