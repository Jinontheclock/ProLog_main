      ...
      <ScrollView style={CommonStyles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.contentCard}>
          ...
          <View style={styles.tagsContainer}>
            ...
            >
              <MaterialIcon name="icon-volume" size={24} color="#000" />
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.actionButtons}>
            <View style={[CommonStyles.neoDoubleOuter, { borderRadius: 24, width: '100%' }]}>
              ...
              >
                ...
                <MaterialIcon name="icon-assignment" size={20} color="#E07843" />
              </TouchableOpacity>
            </View>
            ...
            {!isCompleted && (
              <View style={[CommonStyles.neoDoubleOuter, { borderRadius: 24, width: '100%' }]}>
                ...
                >
                  ...
                  <MaterialIcon name="icon-check" size={20} color="#000" />
                </TouchableOpacity>
              </View>
            )}
          </View>
      ...
      {isAudioModalVisible && (
        <View style={styles.audioControlBarOverlay}>
          <View style={styles.audioControlBar}>
            ...
            >
              <MaterialIcon name="icon-pause" size={24} color="#000" />
            </TouchableOpacity>
            ...
            >
              <MaterialIcon name="icon-close" size={24} color="#000" />
            </TouchableOpacity>
          </View>
        </View>
      )}
