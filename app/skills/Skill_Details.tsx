...
export default function CircuitConceptsScreen() {
    ...
    const handleSpeak = async () => {
        const text = "Skill content text here"; // Replace with actual skill content text
            ...
            >
                ...
                <View style={styles.contentCard}>
                    ...
                    <Text style={styles.subtitle}>
                        Industrial Electrician Level 1
                    </Text>
                    ...
                    <Text style={CommonStyles.bodyText}>
                        The principles of alternating current (AC) involve
                        understanding how electrical current periodically
                        reverses direction, how it is generated (usually by
                        rotating machines), and its key characteristics such as
                        frequency, voltage, and waveform. Apprentices should
                        also understand why AC is used—mainly for its efficiency
                        in transmission and voltage transformation—and how it
                        behaves in different types of electrical circuits.
                    </Text>
                </View>
                    ...
                    <View style={styles.bulletList}>
                        <View style={styles.bulletItem}>
                            ...
                            <View style={styles.bulletContent}>
                                ...
                                <Text style={styles.bulletText}>
                                    ...
                                    periodically, unlike Direct Current (DC),
                        ...
                        <View style={styles.bulletItem}>
                            ...
                            <View style={styles.bulletContent}>
                                ...
                                <Text style={styles.bulletText}>
                                    {" "}
                                    One complete back-and-forth motion of
                                    current flow.
                                </Text>
                            </View>
                        </View>
                        <View style={styles.bulletItem}>
                            ...
                            <View style={styles.bulletContent}>
                                ...
                                <Text style={styles.bulletText}>
                                    {" "}
                                    The number of cycles per second (e.g., 60 Hz
                                    in North America, 50 Hz in many other
                                    countries).
                                </Text>
                            </View>
                        </View>
                ...
                <View style={styles.contentCard}>
                    ...
                    <View style={styles.bulletList}>
                        ...
                        <View style={[styles.bulletItem, { paddingLeft: 20 }]}>
                            ...
                            <View style={styles.bulletContent}>
                                <Text style={styles.bulletText}>
                                    This rotation induces a voltage that
                                    alternates in polarity (positive and
                                    negative).
                                </Text>
                            </View>
                        </View>
                    ...
                    <View style={styles.bulletList}>
                        <View style={styles.bulletItem}>
                            ...
                            <View style={styles.bulletContent}>
                                ...
                                <Text style={styles.bulletText}>
                                    {" "}
                                    Most AC systems use a sine wave because it's
                                    smooth and efficient for power transmission.
                                </Text>
                            </View>
                        </View>
                        <View style={styles.bulletItem}>
                            ...
                            <View style={styles.bulletContent}>
                                ...
                                <Text style={styles.bulletText}>
                                    {" "}
                                    The maximum value (peak) of the voltage or
                                    current in a cycle.
                                </Text>
                            </View>
                        </View>
                        <View style={styles.bulletItem}>
                            ...
                            <View style={styles.bulletContent}>
                                ...
                                <Text style={styles.bulletText}>
                                    {" "}
                                    The effective voltage or current value
                                    (e.g., 120 V RMS in household outlets).
                                </Text>
                            </View>
                        </View>
                        <View style={styles.bulletItem}>
                            ...
                            <View style={styles.bulletContent}>
                                ...
                                <Text style={styles.bulletText}>
                                    {" "}
                                    Describes the time relationship between
                ...
                <View style={styles.actionButtons}>
                    ...
                    >
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                router.push("/skills/Skill_Detail_Quiz")
                            }
                        >
                            <Text
                                style={[
